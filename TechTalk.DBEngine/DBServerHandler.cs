...
namespace TechTalk.DBEngine
{
    ...
    /// Sql server Handler
    /// </summary>
    public interface IDBServerHanlder
    {
        DBResultArgs FetchData(string query, EnumCommand.DataSource dataSourceType, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic);

        DBResultArgs ExecuteCommand(string query, DataValue dv = null, bool getlastinsert_ID = false, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic, string spOutput = "@ReturnValue");

        object ExecuteScalar(string query, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic);

        Task<DBResultArgs> FetchDataAsync(string query, EnumCommand.DataSource dataSourceType, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic);
        Task<DBResultArgs> FetchDataAsyncCopy(string query, EnumCommand.DataSource dataSourceType, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic);

        Task<DBResultArgs> ExecuteCommandAsync(string query, DataValue dv = null, bool getlastinsert_ID = false, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic, string spOutput = "@ReturnValue");
    ...
    public class DBServerHandler : IDBServerHanlder
    {
        /// <summary>
        /// The connection
        /// </summary>
        ...
        public DBServerHandler(IConfiguration configuration)
        {
            connection = new SqlConnection(configuration.GetConnectionString("ConnString")); 
        }
        ...
        /// </returns>
        public DBResultArgs ExecuteCommand(string query, DataValue dv = null, bool getlastinsert_ID = false, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic, string spOutput = "@ReturnValue")
        {
            DBResultArgs result = new DBResultArgs();
            ...
            try
            {
                if (string.IsNullOrEmpty(query))
                {
                    //throw new ArgumentNullException("Query is empty", "ExecuteCommand(DataValue dv, string query");
                     new ErrorLog().WriteLog("Error Handler " + "ExecuteScalar(DataValue,string) " + query + " Query is empty!");
        ...
        /// </returns>
        public DBResultArgs FetchData(string query, EnumCommand.DataSource dataSourceType = EnumCommand.DataSource.DataTable, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic)
        {
            DBResultArgs result = new DBResultArgs();
            result.Success = true;
        ...
        /// -2 --&gt; record referred(delete mode)
        /// </returns>
        public async Task<DBResultArgs> ExecuteCommandAsync(string query, DataValue dv = null, bool getlastinsert_ID = false, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic, string spOutput = "@ReturnValue")
        {
            DBResultArgs result = new DBResultArgs();
            result.Success = false;
            SqlCommand Command = null;
        ...
        /// DataTable with the records
        /// </returns>
        public async Task<DBResultArgs> FetchDataAsync(string query, EnumCommand.DataSource dataSourceType = EnumCommand.DataSource.DataTable, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic)
        {
            DBResultArgs result = new DBResultArgs();
            result.Success = true;
            SqlDataAdapter Adapter;
            SqlCommand Command = null;
            DataSet ds = new DataSet();
            //string Cname = dv.GetItembyName("Custom1").ToString();
            SqlConnection Con = OpenConnection();
            try
            {
        ...
        public async Task<DBResultArgs> FetchDataAsyncCopy(string query, EnumCommand.DataSource dataSourceType = EnumCommand.DataSource.DataTable, DataValue dv = null, EnumCommand.SQLType sqlType = EnumCommand.SQLType.SQLStatic)
        {
            DBResultArgs result = new DBResultArgs();
            result.Success = true;
            SqlDataAdapter Adapter;
